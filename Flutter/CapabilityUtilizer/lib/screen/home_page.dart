...
class _HomePageState extends State<HomePage> {
  ...
  void _sendInput() {
    WidgetsBinding.instance!.addPostFrameCallback((_) {
      ...
      _convaLayer.sendRequest(question, _cpabilityName);
      setState(() {
        _isWaiting = true;
        ...
        appBar: AppBar(
          ...
          actions: [
            DropdownButton<String>(
              value: _cpabilityName,
              onChanged: (String? newValue) {
                setState(() {
                  _cpabilityName = newValue ?? "Default";
                });
              },
              items: Utils.cpabilitiesGroup
